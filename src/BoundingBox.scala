...
class BoundingBox(text: String) extends DrawObject[Array[Int]] with Object with Colorable with Fillable {
  ...
  override def draw(context: DrawContext): Unit = {
    ...
    val coordinates: Array[Int] = leftAlignRectangleCoordinates(arguments(0),arguments(1), arguments(2), arguments(3))
    val shape: Shape = new Rectangle(coordinates(0) * 10, coordinates(1) * 10, (coordinates(2) - coordinates(0)) * 10, (coordinates(3) - coordinates(1)) * 10)
